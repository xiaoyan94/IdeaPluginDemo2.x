...
public class MyPluginMessages {
    ...
    public static void showInfo(String title, String message, @Nullable Project project) {
        final Notification notification = new Notification("ZhiyinOneClickNavigation", title, message, NotificationType.INFORMATION);
    ...
    public static void showInfo(String message, @Nullable Project project) {
        final Notification notification = new Notification("ZhiyinOneClickNavigation", message, NotificationType.INFORMATION);
        notification.setIcon(MyIcons.pandaIconSVG16_2);
        Notifications.Bus.notify(notification, project);
    }

    public static void showError(String title, String message, @Nullable Project project) {
        Notification notification = new Notification("ZhiyinOneClickNavigation", title, message, NotificationType.ERROR);
        notification.setIcon(MyIcons.pandaIconSVG16_2);
        Notifications.Bus.notify(notification, project);
    }

    public static void showWarning(String title, String message, @Nullable Project project) {
        Notification notification = new Notification("ZhiyinOneClickNavigation", title, message, NotificationType.WARNING);
