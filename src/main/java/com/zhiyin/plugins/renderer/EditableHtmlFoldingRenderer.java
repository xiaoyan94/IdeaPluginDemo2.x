...
public class EditableHtmlFoldingRenderer implements EditorCustomElementRenderer {
    ...
    public EditableHtmlFoldingRenderer(@NotNull String originalText, @NotNull String value, @NotNull Editor editor, int startOffset, int endOffset) {
        ...
        // 获取显示文本
        // this.displayText = getI18nValue(); // 耗时
        if (value != null) {
    ...
    public void setDisplayText(@NotNull String text) {
